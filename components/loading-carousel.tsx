        ...
        <div className={cn("bg-muted p-4 ", showIndicators && !backgroundTips ? "lg:py-2 lg:px-4 " : "")}>
          <div className="flex flex-col gap-4">
            ...
            {!backgroundTips && (
              <div className="w-full">
                <div className="text-base lg:text-xl font-medium text-brand-gray min-h-6">
                  <TypewriterText text={displayTips[current]?.text || ""} isActive={true} />
                </div>
              </div>
            )}
          ...
          {showProgress && (
            <motion.div
              ...
              className="h-1 bg-muted origin-left mt-4"
            />
          )}
        </div>
      </div>
