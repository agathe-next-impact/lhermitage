...
import { DevenirSocietaireSlideshow } from "@/components/devenir-societaire-slideshow"
import { DevenirSocietaireMotivations } from "@/components/devenir-societaire-motivations"
import { WordPressLink } from "@/components/wordpress-link"
                  ...
                  <div key={idx} className="bg-brand-gray/5 p-4 md:p-6 rounded-lg">
                    ...
                    {item.caracteristique?.descriptif && (
                      <div
                        ...
                        dangerouslySetInnerHTML={{ __html: item.caracteristique.descriptif }}
                      />
                    )}
                  </div>
                ))}
